...
extension UserPreferences: Samplable {
    static var samples: [UserPreferences] { [sample, sample2, sample3, sample4, sample5, sample6] }
    ...
    static var sample4 = UserPreferences(displayName: "Rod", photo: .sample)
    static var sample5 = UserPreferences(displayName: "Jane", photo: .sample2)
    static var sample6 = UserPreferences(displayName: "Freddy", photo: .sample3)
}
...
extension Conversation: Samplable {
    ...
    static var sample2: Conversation {
        Conversation(displayName: "Fishy chat", unreadCount: 0, members: Member.samples2)
    }
...
extension Member: Samplable {
    ...
    static var samples2: [Member] { [sample, sample2, sample3, sample4, sample5, sample6] }
    ...
    static var sample4: Member {
        Member(userName: "rod@contoso.com", state: .active)
    }
    static var sample5: Member {
        Member(userName: "jane@contoso.com", state: .active)
    }
    static var sample6: Member {
        Member(userName: "freddy@contoso.com", state: .pending)
    }
}
